...
/**
 * @Package: com.shfc.cloud.cloudbase.dao.SourceDatabaseMapper.java
 * @Description: 资源——数据库
 * @Company: 上海房产
...
public interface SourceDatabaseMapper {
     ...
     * @Date 2017/03/27 14:41
     * @param id
     * @return com.shfc.cloud.cloudbase.domain.SourceDatabase
     * @throws []
     */
     ...
     * @return
     */
    List<SourceDatabase> selectByDomainList(SourceDatabase sourceDatabase);
}