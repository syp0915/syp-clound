...
import com.shfc.cloud.account.domain.MerchantCompany;
...
public interface MerchantCompanyMapper {
     ...
     * @Date 2017/03/25 15:30
     * @param id
     * @return com.shfc.cloud.account.domain.MerchantCompany
     * @throws []
     */
     ...
     * @throws []
     */
    List<MerchantCompany> selectByPage(Page<MerchantCompany> page);
}