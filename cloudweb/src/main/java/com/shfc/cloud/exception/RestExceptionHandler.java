...
/**
 * @Package com.shfc.cloud.exception.RestExceptionHandler
...
public class RestExceptionHandler {
    ...
    //cloud web 异常
    @ExceptionHandler({CloudWebException.class})
    @ResponseBody
    public ResultDO<String> cloudWebException(CloudWebException cloudWebException) {
        logException(cloudWebException);
        resultDO.setErrCode(cloudWebException.getErrCode());
        resultDO.setErrMsg(cloudWebException.getMessage());
        return resultDO;
    }
